...
# ============================================================================
# Synthetic Transformer V2 Training Runner Script
#
# Trains Transformer flow matching on synthetic sinusoidal datasets
...
DEVICE=${DEVICE:-"auto"}
SAVE_DIR=${SAVE_DIR:-"${SCRIPT_DIR}/checkpoints_v2"}

# Log file with timestamp and complexity
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="${LOG_DIR}/training_v2_${COMPLEXITY}_${TIMESTAMP}.log"
PID_FILE="${LOG_DIR}/training_v2_${COMPLEXITY}.pid"

# Print configuration
echo "============================================================"
echo "Synthetic Transformer V2 Training Runner"
echo "============================================================"
...
echo "  Feed-forward dimension: ${DIM_FEEDFORWARD}"
...
python3 -c "import sys; sys.path.insert(0, '${SCRIPT_DIR}'); import train_transformer_v2" 2>&1 | head -5
if [ $? -ne 0 ]; then
    echo ""
    echo "❌ Python script has import errors. Full error:"
    python3 -c "import sys; sys.path.insert(0, '${SCRIPT_DIR}'); import train_transformer_v2" 2>&1
    exit 1
fi
...
nohup python3 -u "${SCRIPT_DIR}/train_transformer_v2.py" \
...
echo ""
echo "Example usage:"
echo "  COMPLEXITY=radial EPOCHS=200 ./run_transformer_v2_training.sh"
echo "  NUM_HEADS=4 DIM_FEEDFORWARD=256 ./run_transformer_v2_training.sh"
echo "  TRAIN_SPARSITY=0.1 TEST_SPARSITY=0.1 ./run_transformer_v2_training.sh"
echo ""
